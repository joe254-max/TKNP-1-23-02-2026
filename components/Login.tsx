...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const [is2FAEnabled, setIs2Enabled] = useState(false);
...
>>>>>>> a2dc43e97b1949a1efe4afb9dfd445451e85d4d3
      if (dbUser) {
        ...
        const isStudentPortal = role === UserRole.STUDENT;
        const isAuthorizedForPortal = isStudentPortal
        ...
        if (!isAuthorizedForPortal) {
          setErrorMessage(
            isStudentPortal
              ? 'This account is registered as staff. Please switch to Staff / Lec to log in.'
              : 'This account is registered as a student. Please switch to Student to log in.',
          );
          return;
        }
...
<<<<<<< HEAD
      ...
      sessionStorage.setItem('poly_google_oauth_role', role);
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-slate-50">
      ...
      <div className="hidden lg:flex flex-col justify-between p-16 relative overflow-hidden bg-rose-950">
        ...
        <div className="relative z-30 flex items-center gap-4">
          <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-2xl shrink-0 group transition-transform hover:scale-110 border border-white/20 overflow-hidden">
            <img
              src="/tknp-logo.png"
              alt="TKNP Logo"
      ...
      {/* Right Side: Form */}
      <div className="flex items-center justify-center p-4 sm:p-8 md:p-16 lg:p-24 bg-white overflow-y-auto min-h-screen lg:min-h-0">
        <div className="w-full max-w-md my-auto py-6 sm:py-0">
          {mode === 'forgot-password' && resetEmailSent ? (
            ...
            <>
              ...
              <p className="text-slate-500 mb-6 sm:mb-10 font-medium text-sm sm:text-base">
                {mode === 'login' 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {errorMessage && (
                  <div className="mb-2 px-4 py-3 rounded-2xl bg-rose-50 border border-rose-200 text-rose-800 text-xs font-bold uppercase tracking-widest flex items-start gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full px-6 py-4 pr-12 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-rose-950/10 focus:border-rose-950 outline-none transition font-medium"
                      />
                      <button
                        type="button"
                ...
                {mode !== 'forgot-password' && (
                  <div className="space-y-4 pt-2">
                    ...
                    {/* 2FA UI temporarily disabled per requirements */}
                  </div>
                )}
